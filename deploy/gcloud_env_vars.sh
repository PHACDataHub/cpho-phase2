...
export NETWORK_BASELINE_SECURITY_POLICY_NAME="${PROJECT_SERVICE_NAME}-baseline-security-policies-for-load-balancer"
...
export NETWORK_FORWARDING_IP_NAME="${PROJECT_SERVICE_NAME}-forwarding-rule-ip"
