...
# project DNS vars
export DNS_MANAGED_ZONE_NAME="${PROJECT_SERVICE_NAME}"
...
# ----- ARTIFACT REGISTRY -----
export ARTIFACT_REGISTRY_REPO="${PROJECT_SERVICE_NAME}"

# ----- CLOUD BUILD ----
export BUILD_CLOUD_BUILD_TRIGGER_NAME="${PROJECT_SERVICE_NAME}-main"
