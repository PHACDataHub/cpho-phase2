type Wordmark = {
  ...
  // this is from file asset : https://www.canada.ca/etc/designs/canada/wet-boew/assets/wmms-blk.svg
  //  we injecte the fill proprty in the top level svg element
  export const Wordmark = ({
    // rbg from: canada.ca/en/treasury-board-secretariat/services/government-communications/design-standard/colour-design-standard-fip.html#toc1
    textColor = '#000',
    flagColor = '#EA2D37', // 235 45 55
    width = '80%',
    // maxWidth = '200px'
  }: Wordmark) => {
    return (
