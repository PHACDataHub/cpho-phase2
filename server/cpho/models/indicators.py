...
class Benchmarking(models.Model):
    ...
    UNIT_CHOICES = [
        ("", "--"),
        ("age_standard_rate_per_100K", tdt("Age standardized rates per 100 000 population")),
        ("age_standard_percentage", tdt("Age-standardized percentage")),
        ("ddd_per_1000_per_day", tdt("DDD per 1000 population per day")),
        ("deaths_per_million_inhabitants", tdt("Deaths per million inhabitants")),
        ...
        ("percent_births_below_2500_grams", tdt("Percent of live births below 2500 grams")),
        ("percent_people_fully_vaccinated", tdt("Percent of people fully vaccinated")),
        ("percent_population", tdt("Percent of population")),
        ("percent_population_health_good_or_very_good", tdt("Percent of population that rate their health as good or very good")),
